...
async function getStaticProps() {
  // fetch data from an api
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://admin-pooh:Test123@cluster0.za3vp.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
